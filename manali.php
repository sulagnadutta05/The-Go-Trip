    ...
    <div class="row g-4 pb-5">
      ...
      <div class="col-6 col-md-6 col-lg-4">
        <div class="card tour-card h-100">
          <a href="#">
            <img src="images/manali1.jpg" class="card-img-top" alt="Dodham Yatra By Helicopter">
          </a>
          <div class="card-body d-flex flex-column">
            ...
            <h5 class="card-title" title="Exotic Manali (3 N/4 D) By Car Ex Chandiga...">Exotic Manali (3 N/4 D) By Car
              Ex Chandiga...
            </h5>
      ...
      <div class="col-6 col-md-6 col-lg-4">
        <div class="card tour-card h-100">
          <a href="#">
            <img src="images/manali2.jpg" class="card-img-top" alt="Weekend Dalhousie Trip">
          </a>
          <div class="card-body d-flex flex-column">
            <div class="d-flex align-items-center text-muted small mb-3">
              <i class="fa-solid fa-clock-rotate-left"></i>&nbsp;
            ...
            <h5 class="card-title fw-semibold text-truncate" title="Weekend Dalhousie Trip (by Volvo via Dhara...">
              Exotic Manali (3 N/4 D) By Car Ex-Delhi</h5>
            <p class="price">On Request</p>
          </div>
        </div>
      </div>
